package com.criel.train.${module}.service;
...
import com.criel.train.${module}.domain.generated.${Domain};
import com.criel.train.${module}.domain.generated.${Domain}Example;
